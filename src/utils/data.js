...
const servicesData = [
  {
    cardIcon: experience,
    cardHeading: "Разработка ПО",
    cardSubtitle: `Создание программных решений на базе 1С, сайтов и веб‑приложений с использованием React: от прототипов до готовых продуктов под задачи бизнеса.`,
    cardPrice: "от 2000 рублей за час",
  },
  {
    cardIcon: experience,
    cardHeading: "Обновление 1С",
    cardSubtitle: `Профессиональное обновление конфигураций 1С, перенос данных и настройка модулей для бесперебойной работы учётных систем.`,
    cardPrice: "от 1500 рублей за час",
  },
  {
    cardIcon: experience,
    cardHeading: "Техническая поддержка",
    cardSubtitle: `Оперативная помощь пользователям: диагностика и устранение неполадок, консультации и решение типовых ИТ‑вопросов в согласованные сроки`,
    cardPrice: "от 1500 рублей за час",
  },
  {
    cardIcon: experience,
    cardHeading: "Администрирование сетей и серверов",
    cardSubtitle: `Администрирование сетей и инфраструктуры: мониторинг, резервное копирование, настройка оборудования и обеспечение безопасности ИТ‑систем.`,
    cardPrice: "договорная (по количеству оборудования)",
  },
  {
    cardIcon: experience,
    cardHeading: "Внедрение 1С",
    cardSubtitle: `Полный цикл работ по запуску 1С на предприятии: настройка типовой конфигурации, интеграция с существующими системами, обучение сотрудников и сопровождение на стартовом этапе.`,
    cardPrice: "от 2000 рублей в час",
  },
  {
    cardIcon: experience,
    cardHeading: "Разработка ПО",
    cardSubtitle: `Создание программных решений на базе 1С и веб‑приложений с использованием React: от прототипов до готовых продуктов под задачи бизнеса.`,
  },
];

export { aboutData, productData, servicesData };
