...
const productData = [
  {
    ...
    cardPrice: "от 2000 рублей за час",
    cardSubtitle:
  ...
  },
  {
    ...
    cardPrice: "договорная (от количества привлеченных специалистов)",
    cardType: "row",
    cardSubtitle:
  ...
  },
  {
    ...
    cardPrice: "договорная (по количеству оборудования)",
    cardSubtitle:
    ...
    cardDetails: [
      {
        ...
        text: "Обеспечиваем мониторинг состояния компьютерной техники и ИТ‑инфраструктуры. Благодаря централизованному приему заявок, сотрудники знают о проблеме уже в первые 15 минут после обращения.",
      },
      {
        name: "Проактивная диагностика и устранение неполадок",
        text: "Регулярно проводим автоматизированную диагностику оборудования и программного обеспечения. Анализируем логи, отслеживаем тенденции изменения производительности, выявляем потенциальные точки отказа. Заранее заменяем компоненты с признаками износа, обновляем драйверы и ПО, оптимизируем настройки системы. Такой подход позволяет сократить количество аварийных ситуаций на 70–80 % по сравнению с реактивным обслуживанием.",
      },
      {
      ...
      },
      {
        ...
        text: "Заменяем и модернизируем комплектующие для повышения производительности техники. Устанавливаем новые процессоры, оперативную память, накопители, видеокарты и блоки питания. Подбираем оптимальные конфигурации под задачи клиента. Гарантируем совместимость новых компонентов с существующей системой и проводим тестирование после установки.",
      },
    ],
  },
  {
    ...
    cardPrice: "от 1500 рублей за час",
    cardType: "row",
    cardSubtitle:
