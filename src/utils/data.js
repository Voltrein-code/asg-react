  ...
  },
  {
    ...
    cardDetails: [
      ...
      },
      {
        ...
        Вы можете обратиться к нас для подбора оборудования и проектирования программного обеспечения, а также обучения персонала на рабочих местах. Мы поможем выбрать оптимальное решение для конкретной компании и обучить персонал работе с программным обеспечением.`,
      },
      {
